      ...
      <div className="h-[60px] px-4 flex items-center justify-between bg-[#202c33] border-b border-[#222d34]">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="lg:hidden w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#374045] transition-colors mr-1"
          >
          ...
          <div className="w-10 h-10 rounded-full bg-[#6b7b8d] flex items-center justify-center overflow-hidden cursor-pointer">
            {otherUser?.profilePicture ? (
              ...
              <svg viewBox="0 0 212 212" className="w-full h-full">
                ...
                <path fill="#FFF" d="M106.002 125.5c2.645 0 5.212-.253 7.68-.737a38.272 38.272 0 0 0 3.624-.896 37.124 37.124 0 0 0 5.12-1.958 36.307 36.307 0 0 0 6.15-3.67 35.923 35.923 0 0 0 9.489-10.48 36.558 36.558 0 0 0 2.422-4.84 37.051 37.051 0 0 0 1.716-5.25c.299-1.208.542-2.443.725-3.701.275-1.887.417-3.827.417-5.811s-.142-3.925-.417-5.811a38.734 38.734 0 0 0-1.215-5.494 36.68 36.68 0 0 0-3.648-8.298 35.923 35.923 0 0 0-9.489-10.48 36.347 36.347 0 0 0-6.15-3.67 37.124 37.124 0 0 0-5.12-1.958 37.67 37.67 0 0 0-3.624-.896 39.875 39.875 0 0 0-7.68-.737c-21.162 0-37.345 16.183-37.345 37.345 0 21.159 16.183 37.342 37.345 37.342z" />
              </svg>
            )}
          </div>
